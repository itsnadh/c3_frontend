...
<div class="overflow-x-auto">
    <div class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center font-sans overflow-hidden">
        <div class="w-full ">
            <h1 class="mt-7 mb-2 text-2xl font-bold text-center">PRODUCT TABLE</h1>
            <div class="bg-white shadow-md rounded my-6">
                <table class="min-w-max w-full table-auto">
                    ...
                    <tbody v-if="product" class="text-gray-600 text-sm font-light">
                        <tr v-for="product in product.data" :key="product.product_id" class="border-b border-gray-200 hover:bg-gray-100">
            ...
            <a href="/admin/product/create" class="bg-pink-500 text-black w-auto bg-primary-600 hover:text-white focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center bg-blue dark:hover:bg-white-700 dark:focus:ring-primary-800">
            New Product
            </a>
        </div>
    </div>
